                ...
                <div class="grid_12">
                    ...
                    <nav class="nav put-right">
                        <ul class="sf-menu">
                            ...
                            <li><a href="#">Account</a>
								<ul>
									<li><a href="http://localhost/iplt20/login/index.php">login</a></li>
                                    <li><a href="http://localhost/iplt20/login/register.php">sign up</a>
                                    </li>
								</ul>
							</li>
							<li>							
...
<?php
           echo "<a name='ti'></a> <table id='cskbg' BORDERCOLOR='RED'  border=9 style='width:70%; text-align:center; padding-right:100px'> 
							...
							while($row = $res->fetch_assoc()) 
								...
								echo "<td>".$row["bowler"]."</td><td>".$row["bowlerstat"]."</td>";echo "<td></td><td><a href='http://localhost/iplt20/primex/NOindex.php'>Refresh</a</td></tr>";
								echo "</tr>";
