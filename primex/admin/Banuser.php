...
$sql = "UPDATE user SET usertypeid=0 WHERE userid='$email'";
if (mysqli_query($conn, $sql)) {
    ?>
        <script>alert('User Banned successfully ');</script>
        <?php
...
<tr>
<td><button type="submit" name="Ban">Submit To ban user</button></td>
</tr>
</table>
</form>
</div>
